...
logic inline), this script exercises the *actual* ``team_8.CuRobo``
...
Run inside the container (with the manip_challenge sim running on the host):
  docker compose run --rm -p 8080:8080 ai_planner \\
    python3 /ros2_ws/src/team_8/scripts/test_curobo_pipeline_viz.py
...
from team_8.live_viz_helpers import resolve_urdf, resolve_urdf_string
